...
public partial class AprobacionSolicitudActividad
{

    public int idAprobacionSolicitudActividad { get; set; }
    ...
    public virtual SolicitudActividad SolicitudActividad { get; set; }
